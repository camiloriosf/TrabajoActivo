      ...
      <div className={classes.root}>
        ...
        <div className={classes.content}>
          ...
          <Typography type="subheading" paragraph>
            El dueño de TrabajoActivo es Bittersweet SPA, domiciliado en Santiago de Chile.
            <br /><br />
            Nuestro objetivo es ayudar a profesionales de todo el mundo a alcanzar sus metas laborales. Nuestros servicios están diseñados para ser un apoyo en el crecimiento profesional de nuestros usuarios.
          </Typography>
          ...
          <section id="introduccion">
            ...
            <Typography type="subheading" className={classes.quote} paragraph>
              Cuando utilizas nuestros Servicios aceptas cumplir todos estos términos. Tu uso de nuestros Servicios también está sujeto a nuestra <Link href="/cookies"><a>Política de cookies</a></Link> y a nuestra <Link href="/privacy"><a>Política de privacidad</a></Link>, que abarca el modo en que recabamos, utilizamos, compartimos y almacenamos tu información personal.
            </Typography>
            <Typography type="body1" paragraph>
              Al hacer clic en «Crear Mi CV», «Inicia Sesión», «Regístrate» u otro enlace similar, al registrarte, acceder o utilizar nuestros servicios (descritos a continuación), aceptas suscribir un contrato vinculante desde el punto de vista jurídico con TrabajoActivo (incluso si estás utilizando nuestros Servicios en nombre de una empresa). Si no estás conforme con este contrato («Contrato» o «Condiciones de uso»), no hagas clic en «Regístrate» (u otro enlace similar) y no accedas ni utilices de otro modo nuestros Servicios.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              Este Contrato se aplica a TrabajoActivo.com, a las aplicaciones de la marca de BitterSweet y a otros sitios relacionados con BitterSweet, aplicaciones, comunicaciones y otros servicios que enuncian que se ofrecen en virtud de este Contrato («Servicios»), incluida la recopilación de datos al margen del sitio web para esos Servicios, como nuestros anuncios. Los usuarios suscritos a nuestros Servicios son «Miembros» y los usuarios no registrados son «Visitantes». Este Contrato se aplica a ambos.
            </Typography>
            <Typography type="body2">
              BitterSweet SPA
            </Typography>
            <Typography type="body1" paragraph>
              Estás suscribiendo este Contrato con BitterSweet SPA (también referido como «nosotros» o «nuestro»). Independiente de donde residas, estás formalizando este Contrato con BitterSweet SPA y los datos personales que nos proporciones o se recopilen en nuestros Servicios serán controlados por BitterSweet SPA.
            </Typography>
            <Typography type="title" paragraph>
              1.2 Miembros y Visitantes
            </Typography>
            <Typography type="body1" paragraph>
              Cuando te registras y te unes al Servicio de TrabajoActivo, te conviertes en Miembro. Si has decidido no registrarte en nuestros Servicios, puedes acceder a determinadas funcionalidades como Visitante.
            </Typography>
            <Typography type="title" paragraph>
              1.3 Cambios
            </Typography>
          ...
          <section id="obligaciones">
            ...
            <Typography type="body1" paragraph>
              Para utilizar los Servicios, aceptas que: (1) tienes al menos la «Edad mínima» (definida a continuación); (2) solo tendrás una cuenta de TrabajoActivo, que deberá estar a tu nombre real; y (3) TrabajoActivo no te ha restringido el uso de los Servicios.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              «Edad mínima» significa 16 años. No obstante, si la legislación aplicable exige que debes tener más edad para que TrabajoActivo te proporcione lícitamente los Servicios sin consentimiento de tus padres (incluido el uso de tus datos personales), entonces la Edad mínima será esa otra edad.
            </Typography>
            <Typography type="title" paragraph>
              2.2 Tu cuenta
            </Typography>
            ...
            <Typography type="body1" paragraph>
              • Todas tus compras de Servicios están sujetas a la política de reembolso de TrabajoActivo.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              Puedes obtener una copia de tu factura a través de tu configuración de cuenta en TrabajoActivo bajo «Historial de compra».
            </Typography>
            <Typography type="title" paragraph>
            ...
            <Typography type="body1" paragraph>
              La información y el contenido que compartes o publicas pueden ser vistos por otros Miembros o Visitantes. Cuando exista la posibilidad de establecer una configuración, respetaremos las opciones que escojas sobre quién puede ver el contenido o la información.
            </Typography>
            <Typography type="body1" paragraph>
          ...
          <section id="derechos">
            ...
            <Typography type="title" paragraph>
              3.1 Tu licencia respecto a TrabajoActivo
            </Typography>
            <Typography type="subheading" className={classes.quote} paragraph>
              ...
              <br /><br />
              Te comprometes a suministrarnos únicamente la información y el contenido sobre los que tengas derecho y a que la información en tu perfil de TrabajoActivo sea verdadera.
            </Typography>
            <Typography type="body1" paragraph>
              Entre tú y TrabajoActivo, eres el propietario del contenido y de la información que proporciones o publiques en los Servicios, y solo otorgas a TrabajoActivo y a nuestras filiales la siguiente licencia no exclusiva: un derecho mundial, transferible y sujeto a sublicencia para usar, copiar, modificar, distribuir, publicar y tratar la información y los contenidos que nos proporciones a través de nuestros Servicios sin ningún consentimiento adicional, notificación o compensación para ti o terceros. Estos derechos se limitan de los siguientes modos:
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              Al enviar a TrabajoActivo sugerencias u otros comentarios sobre nuestros Servicios, aceptas que TrabajoActivo utilice y comparta (aunque no tiene que hacerlo) dichos comentarios para cualquier finalidad sin compensarte.
            </Typography>
            <Typography type="body1" paragraph>
              Aceptas solo proporcionar contenido e información que no infrinja la ley ni los derechos de ninguna persona (incluidos los derechos de propiedad intelectual). También acuerdas facilitar información verdadera en tu perfil. A TrabajoActivo se le puede exigir por ley retirar determinada información o contenido en ciertos países.
            </Typography>
            <Typography type="title" paragraph>
            ...
            <Typography type="body1" paragraph>
              TrabajoActivo no es un servicio de almacenamiento. Aceptas que no tenemos la obligación de almacenar, conservar o proporcionarte una copia de cualquier contenido o información que nos facilites tú u otras personas, salvo en la medida en que se exija por ley y tal y como se señala en nuestra Política de privacidad.
            </Typography>
            <Typography type="title" paragraph>
            ...
            <Typography type="body1" paragraph>
              TrabajoActivo se reserva todos sus derechos de propiedad intelectual en los Servicios. La utilización de los Servicios no te confiere la propiedad de los mismos ni del contenido o de la información que se muestra a través de los mismos. Las marcas y los logotipos utilizados en relación con los Servicios son las marcas comerciales de sus respectivos propietarios. TrabajoActivo y otras marcas de BitterSweet, las marcas de servicio, los gráficos y los logotipos utilizados para nuestros Servicios son marcas registradas de BitterSweet SPA.
            </Typography>
          </section>
          <section id="exclusion">
            ...
            <Typography type="body1" paragraph>
              EN LA MEDIDA EN QUE LO PERMITA LA LEY, TRABAJOACTIVO Y SUS AFILIADOS (Y QUIENES TRABAJAN CON TRABAJOACTIVO PARA PROPORCIONAR LOS SERVICIOS) (A) NO SE HACEN RESPONSABLES DE NINGUNA GARANTÍA IMPLÍCITA O REPRESENTACIÓN (COMO GARANTÍAS DE COMERCIALIZACIÓN, ADECUACIÓN PARA UN FIN PARTICULAR, EXACTITUD DE LOS DATOS Y DE NO INFRACCIÓN); (B) NO GARANTIZAN QUE LOS SERVICIOS PODRÁN UTILIZARSE SIN INTERRUPCIONES O SIN ERRORES DE FUNCIONAMIENTO, Y (C) PROPORCIONARÁN EL SERVICIO (INCLUIDO EL CONTENIDO Y LA INFORMACIÓN) TAL Y COMO ESTÉ DISPONIBLE.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              EN LA MEDIDA EN QUE LO PERMITA LA LEY (Y SALVO QUE TRABAJOACTIVO HAYA SUSCRITO UN CONTRATO ESCRITO INDEPENDIENTE QUE REEMPLACE ESTE CONTRATO), TRABAJOACTIVO Y SUS AFILIADOS (Y QUIENES TRABAJAN CON TRABAJOACTIVO PARA PROPORCIONAR LOS SERVICIOS) NO SE HARÁN RESPONSABLES DE NINGÚN DAÑO INDIRECTO, INHERENTE, ESPECIAL, CONSECUENTE O PUNITIVO, O POR LA PÉRDIDA DE DATOS, DE OPORTUNIDADES, DE REPUTACIÓN O DE BENEFICIOS O INGRESOS RELACIONADOS CON LOS SERVICIOS (COMO DECLARACIONES OFENSIVAS O DIFAMATORIAS, TIEMPO PERDIDO, USO O CAMBIOS EN TU INFORMACIÓN O CONTENIDO).
            </Typography>
            <Typography type="body1" paragraph>
              LA RESPONSABILIDAD DE TRABAJOACTIVO Y SUS AFILIADOS (Y DE QUIENES TRABAJAN CON TRABAJOACTIVO PARA PROPORCIONAR LOS SERVICIOS) NO SUPERARÁ EN NINGÚN CASO, UNA VEZ SUMADAS TODAS LAS REIVINDICACIONES, LA CANTIDAD QUE SEA INFERIOR DE (A) CINCO VECES LA CUOTA MENSUAL O ANUAL MÁS RECIENTE QUE HAYAS PAGADO POR UN SERVICIO PREMIUM, SI CORRESPONDE, O (B) 500 USD.
            </Typography>
            <Typography type="body1" paragraph>
              ESTA LIMITACIÓN DE RESPONSABILIDAD FORMA PARTE DEL ACUERDO ENTRE TÚ Y TRABAJOACTIVO, Y SE APLICARÁ A TODAS LAS RECLAMACIONES DE RESPONSABILIDAD (COMO GARANTÍA, DAÑO, NEGLIGENCIA, CONTRATO, LEY), INCLUSO AUNQUE SE HAYA COMUNICADO A TRABAJOACTIVO Y A SUS AFILIADOS ESTE DAÑO, E INCLUSO AUNQUE ESTAS SOLUCIONES NO SUBSANEN SU FINALIDAD ESENCIAL.
            </Typography>
            <Typography type="body1" paragraph>
          ...
          <section id="rescision">
            ...
            <Typography type="body1" paragraph>
              Tanto tú como TrabajoActivo podréis dar por concluido este Contrato en cualquier momento tras comunicarlo a la otra parte. Una vez rescindido, perderás el derecho a acceder y utilizar los Servicios. Lo siguiente continuará aplicándose tras la rescisión:
            </Typography>
            <Typography type="body1" paragraph>
          ...
          <section id="resolucion">
            ...
            <Typography type="subheading" className={classes.quote} paragraph>
              En el caso improbable de que se produjera una disputa legal, acordamos someternos a los tribunales de Chile (y a la jurisdicción de Santiago).
            </Typography>
            <Typography type="body1" paragraph>
              Aceptas que la legislación de Santiago, Chile, excepto en los casos de conflicto de jurisdicción, prevalecerá en cualquier disputa relacionada con este Contrato y/o los Servicios. Ambas partes acordamos que todas estas demandas solo podrán presentarse ante los tribunales de Santiago, Chile, y ambas partes aceptamos someternos a la jurisdicción de esos tribunales.
            </Typography>
          </section>
          <section id="disposiciones">
            ...
            <Typography type="body1" paragraph>
              Si un tribunal con autoridad sobre este Contrato encuentra que no puede aplicarse alguna parte del mismo, tú y nosotros aceptamos que el tribunal modifique los términos para que esa parte sí pueda aplicarse y siga logrando su finalidad. Si el tribunal no pudiera conseguirlo, tú y nosotros acordamos pedir al tribunal que elimine esa parte que no puede aplicarse y que mantenga el resto del Contrato. Este Contrato (incluidos los términos adicionales que establezcamos cuando interacciones con una funcionalidad de los Servicios) es el único acuerdo entre nosotros sobre los Servicios y reemplaza todos los acuerdos anteriores sobre los Servicios.
            </Typography>
            <Typography type="body1" paragraph>
              Si no actuamos en caso de incumplimiento de este Contrato, ello no significa que TrabajoActivo haya renunciado a su derecho a hacer valer el Contrato. No puedes ceder o transferir este Contrato (o tu cuenta o uso de los Servicios) a nadie sin nuestro consentimiento. No obstante, aceptas que TrabajoActivo ceda este Contrato a sus filiales o a una tercera parte que lo compre sin tu consentimiento. No existen otros terceros beneficiarios del Contrato.
            </Typography>
            <Typography type="body1" paragraph>
          ...
          <section id="deberes">
            <Typography type="display1" paragraph className={classes.title}>
              8. Lo que se debe y no se debe hacer en TrabajoActivo
            </Typography>
            <Typography type="title" paragraph>
            ...
            <Typography type="body1" paragraph>
              d. Crear una identidad falsa en TrabajoActivo. La creación ocasional de perfiles claramente ficticios por parte de TrabajoActivo o con su permiso expreso en relación con una campaña promocional no exonera de esta obligación.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              j. Enviar o publicar publicidad no solicitada o no autorizada, «correo basura», «spam», «cartas en cadena», «estafas piramidales» o cualquier otra forma de publicidad no autorizada por TrabajoActivo.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              m. Copiar, utilizar, divulgar o distribuir cualquier información obtenida de los Servicios, ya sea de forma directa o a través de terceros (como los motores de búsqueda), sin el consentimiento de TrabajoActivo.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              q. Infringir los derechos de propiedad intelectual de otras personas como derechos de autor, patentes, marcas, secretos comerciales u otros derechos de propiedad.
            </Typography>
            <Typography type="body1" paragraph>
              r. Infringir la propiedad intelectual u otros derechos de TrabajoActivo, incluido, sin limitación, (i) copiar o distribuir nuestros vídeos de aprendizaje u otros materiales; o (ii) copiar o distribuir nuestra tecnología, salvo que se ponga en circulación con licencias de código abierto; (iii) utilizar el término «TrabajoActivo» o nuestros logotipos en cualquier nombre comercial, correo electrónico o URL excepto en los casos descritos en las Directrices de marca.
            </Typography>
            <Typography type="body1" paragraph>
              s. Utilizar las invitaciones de TrabajoActivo para enviar mensajes a personas que no te conocen o que es poco probable que te reconozcan como un contacto conocido.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              y. Dar a entender o declarar que estás asociado o avalado por TrabajoActivo sin nuestro consentimiento expreso.
            </Typography>
            <Typography type="body1" paragraph>
              z. Alquilar, arrendar, prestar, hacer negocios, vender o revender el acceso a los Servicios o a datos relacionados.
            </Typography>
            <Typography type="body1" paragraph>
              aa. Vender, patrocinar u obtener de otro modo un beneficio económico de cualquier Servicio sin el consentimiento de TrabajoActivo.
            </Typography>
            <Typography type="body1" paragraph>
              ab. Establecer enlaces a nuestros Servicios para cualquier otra finalidad que la de promover tu perfil o un grupo en nuestros Servicios, sin el consentimiento de TrabajoActivo.
            </Typography>
            <Typography type="body1" paragraph>
            ...
            <Typography type="body1" paragraph>
              ai. Acceder a los Servicios salvo a través de las interfaces expresamente proporcionadas por TrabajoActivo, como sus aplicaciones móviles y TrabajoActivo.com.
            </Typography>
            <Typography type="body1" paragraph>
          ...
          <section id="contactarnos">
            ...
            <Typography type="body1" paragraph>
              POR INTERNET: contact@bittersweet.io
            </Typography>
            <Typography type="body1" paragraph>
              O POR CORREO POSTAL: General Adolfo Holley 133 Providencia, Santiago, Chile
            </Typography>
          </section>
        </div>
