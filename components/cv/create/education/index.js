...
class Index extends Component {
  ...
  onEducationAdd = ({ index }) => () => {
    this.props.doAddNewEducation({ index });
    this.delayedSaving({ selected: this.props.cv.id });
  }
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <SectionHeader
          title={cv.text !== '' ? cv.text : t('create.sections.education.title')}
          subtitle={t('create.sections.education.subtitle')}
          id={cv.id}
          editable
            ...
            <Grid container >
              <Grid item xs={12}>
                <Typography type="body2" color="secondary" className={classes.tipSubtitle}>
                  {t('create.sections.education.tips.text1')}
                </Typography>
                <Typography type="body2" color="secondary" className={classes.tipSubtitle}>
                  {t('create.sections.education.tips.text2')}
                </Typography>
                <TipCard text={t('create.sections.education.tips.tip1')} />
                <TipCard text={t('create.sections.education.tips.tip2')} wrong />
                <Typography type="body2" color="secondary" className={classes.tipSubtitle}>
                  {t('create.sections.education.tips.text3')}
                </Typography>
              </Grid>
            </Grid>
          </div>
                      ...
                      <div>
                        ...
                        >
                          <Item
                            ...
                            handleEducationAdd={this.onEducationAdd}
                            handleEducationDelete={this.onEducationDelete}
                          />
                        </div>
...
const mapDispatchToProps = dispatch => ({
  ...
  doAddNewEducation: bindActionCreators(doAddNewEducation, dispatch),
